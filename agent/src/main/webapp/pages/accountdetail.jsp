...
<div class="mbxnav">
	<a href="javascript:void(0);">代理商管理</a> \ <a href="/selfAccount">当前账户信息</a> \ <a href="/selfAccount">查看账户明细</a>
</div>
<div class="container">
<!-- 
...
<link id='theme' rel='stylesheet' href='${pageContext.request.contextPath }/css/accountdetail.css'/>
