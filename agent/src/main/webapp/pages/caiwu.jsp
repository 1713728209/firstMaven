...
<div class="mbxnav">
	<a href="javascript:void(0);">系统管理</a> \ <a href="/caiwu">财务管理</a>
</div>
<div class="container">
...
<link id='theme' rel='stylesheet' href='${pageContext.request.contextPath }/css/caiwu.css'/>
<script type="text/javascript" src="${pageContext.request.contextPath }/js/caiwu.js" charset="UTF-8"></script> 
