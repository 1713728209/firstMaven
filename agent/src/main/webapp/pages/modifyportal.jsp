...
<div class="mbxnav">
	<a href="/myportalmanage">门户管理</a> \ <a href="modifyportal?id=&keywords.customId=">修改门户信息</a>
</div>
<div class="container">
...
<link id='theme' rel='stylesheet' href='${pageContext.request.contextPath }/css/modifyportal.css'/>
<script type="text/javascript" src="${pageContext.request.contextPath }/js/modifyportal.js" charset="UTF-8"></script> 
