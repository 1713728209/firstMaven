...
<div class="mbxnav">
	<a href="myportalmanage">门户管理</a> \ <a href="myportalmanage.action">门户管理</a>
</div>
<div class="container">
...
<link id='theme' rel='stylesheet' href='${pageContext.request.contextPath }/css/myportallist.css'/>
<script type="text/javascript" src="${pageContext.request.contextPath }/js/myportallist.js" charset="UTF-8"></script> 
