...
<link id='theme' rel='stylesheet' href='${pageContext.request.contextPath }/css/viewportal.css'/>
<script type="text/javascript" src="${pageContext.request.contextPath }/js/viewportal.js" charset="UTF-8"></script> 
