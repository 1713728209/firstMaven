...
<link id='theme' rel='stylesheet' href='${pageContext.request.contextPath }/css/xufei.css'/>
<script type="text/javascript" src="${pageContext.request.contextPath }/js/xufei.js" charset="UTF-8"></script> 
</body></html>